...
const DefaultLayout = ({ children, className }) => {
    return (
        ...
        >
            <Seo title={"Nemos"} description={"Estudia el PER con viento de popa"} article={false} />
            <NavBar className="col-start-1 col-span-3" />
            <main className={`col-start-1 col-span-3 row-start-2 mb-5 ${className ? className : ""}`}>{children}</main>
