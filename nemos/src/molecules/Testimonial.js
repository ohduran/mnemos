  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`row-start-2 self-center justify-self-center mx-1 pt-5 text-xl ${quoteStyles.quote} `}>
          <blockquote className="mt-3 md:mt-5 mx-2 font-semibold">{children}</blockquote>
        </div>
