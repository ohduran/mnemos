...
export default function Ciencia({ data }) {
  return (
    <DefaultLayout>
      ...
      Es posible que tu experiencia como estudiante con los exámenes no fuese del todo buena. Sin embargo, la ciencia ha demostrado que examinarse no sólo comprueba tus conocimientos, sino que también es una herramienta eficaz para consolidarlos. En Nemos, estudiar es un examen, ¡y fallar no es algo malo! El <em>recuerdo activo</em>, tratar de recordar la respuesta sin mirar, es un componente fundamental del aprendizaje.
      </Teaser>
