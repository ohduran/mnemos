        ...
        <DefaultLayout>
            ...
            >
                <div className="w-11/12 lg:w-8/12 max-w-4xl mx-auto">
                    ...
                    <p className="mt-5 text-lg sm:text-2xl lg:text-3xl leading-loose sm:leading-relaxed lg:leading-loose">
                        El método de{" "}
                        <span className="font-family-secondary text-xl sm:text-3xl md:text-4xl">flash cards</span> con
                        el que aprenderás más rápido y por más tiempo todo lo que necesitas para navegar en la mar con
                        confianza.
                    </p>
                    <div
                ...
                >
                    ...
                    <div className="col-start-1 col-span-2 row-start-2 mt-5 p-1">
                        <h3 className="text-xl sm:text-3xl md:text-4xl font-bold">
                            Conviértete en patrón, <br className="hidden md:block" /> incluso si no tienes tiempo.
                        </h3>
            ...
            <section>
                ...
                >
                    <h3>¿Cómo funciona?</h3>
                    <p>
                        Los métodos tradicionales intentan "copiar y pegar" el temario en tu cabeza con clases y
                        lecciones. Pero el cerebro no funciona como un ordenador, sino como un músculo.
                    </p>
                    <p>
                        Nemos funciona gracias a dos conceptos muy simples: el recuerdo activo y la repetición
                        espaciada. A base de entrenamiento diario, ejercicios de dificultad progresiva y repeticiones,
                        tu mente procesará, integrará y memorizará casi sin esforzarse.
                    </p>
                </article>
            </section>
            {/* <section>
            ...
            <section>
                ...
                >
                    ...
                    <p>
                        ...
                        <em>hacerte preguntas y tratar de recordar la respuesta sin mirar</em>. No se parece en nada a
                        lo que hacemos tradicionalmente al estudiar, que es leer el temario, escuchar a un profesor dar
                        clase o ver videos repetidas veces sin pararnos a pensar en si estamos aprendiendo algo.
                    </p>
                    <p>
                        La ciencia ha demostrado hasta la saciedad que{" "}
                        <strong>la manera tradicional de estudiar no funciona</strong>. Al hacer una lectura pasiva, nos
                        engañamos a nostros mismos, creyendo que nos cunde cuando en realidad estamos perdiendo el
                        tiempo.
                    </p>
                    <FlashCardSet
                        ...
                        questions={[
                            {
                                prompt: "¿Cómo se llama el método de estudio que consiste en hacerse preguntas y tratar de recordar las respuestas?",
                                answer: "Recuerdo activo",
                                sectionTitle: "Introducción a Nemos",
                            },
                            {
                                prompt: "¿A qué conclusión ha llegado la ciencia con respecto a la eficacia de leer el temario varias veces como método de estudio?",
                    ...
                    />
                    <p>
                        ¿Por qué el recuerdo activo es sí es útil? Los neurocientíficos han llegado a dos importantes
                        conclusiones:
                    </p>
                    <ol className="">
                        <li className="">
                            Al intentar recordar algo, <strong>reconsolidamos</strong> el recuerdo, aumentando la
                            probabilidad de que lo recordemos en el futuro.
                        </li>
                        <li>
                            Al cometer un error, nos indica que esa parte del temario aún no la hemos interiorizado.{" "}
                            <strong>Los errores son una brújula</strong> que nos dice dónde debemos dedicar más tiempo
                            de estudio.
                        </li>
                    </ol>

                    <p>
                        Todos los cursos de preparación para el PER incluyen tests, pero ponen el enfoque en la pizarra
                        y las clases. Con Nemos, ponemos a tu disposición <em>flash cards</em> pensadas especialmente en
                        consolidar los conocimientos, no en evaluarlos. Con los "exámenes de años anteriores",
                        compruebas si lo has aprendido;{" "}
                        <strong>
                    ...
                    <FlashCardSet
                        ...
                        questions={[
                            {
                                prompt: "Al intentar recordar algo, ¿qué ocurre con ese recuerdo?",
                            ...
                            {
                                prompt: "¿Por qué cometer errores no es algo malo con la técnica del recuerdo activo?",
                                answer: (
                                    <span>
                                        Porque los errores son una <span className="italic"> brújula</span>.
                                    </span>
                                ),
                                sectionTitle: "Introducción a Nemos",
                            },
                            {
                                prompt: "¿Qué diferencia hay entre las flash cards de Nemos y las preguntas de 'exámenes de años anteriores' de otros cursos?",
                                answer: "Las flash cards reconsolidan recuerdos, y los exámenes comprueban lo que sabes.",
                                sectionTitle: "Introducción a Nemos",
                            },
                            {
                                prompt: "¿Qué implica que un recuerdo se 'reconsolide' cuando tratamos de recordarlo?",
                    ...
                    <h4>Usar o Perder</h4>
                    <p>
                        Tu cerebro es un órgano eficiente: rápidamente borra la información que no le parece útil. Por
                        ejemplo, es posible que no recuerdes lo que comiste el pasado sábado. En cambio, si ese día
                        fuiste a un restaurante increíble y te has pasado toda la semana hablando sin parar sobre lo
                        alucinante que fue, entonces tendrás un recuerdo mucho más nítido.
                    </p>
                    <p>
                        Este protocolo de <em>usar o perder</em> es la manera en que funciona tu cerebro. Si pasas una
                        tarde entera memorizando los nombres de las partes de un barco, y lo dejas a un lado para
                        ponerte con otra cosa durante una semana, para cuando llegue el momento de examinarte habrás
                        olvidado la gran mayoría. De hecho, algunos estudios sugieren que olvidamos en torno al 75% de
                        lo que aprendemos al cabo de 48 horas.
                    </p>
                    <p>
                        Esto puede ser descorazonador, si no fuera por que la solución es muy simple: repasar. Al volver
                        a estudiar conceptos que hemos aprendido hace poco, podemos aumentar la cantidad de conceptos
                        que recordamos de manera significativa.
                    </p>
                    ...
                    <FlashCardSet
                        ...
                        questions={[
                            {
                                prompt: "Si no repasamos, ¿cuánto tiempo tardamos en perder el 75% de lo que aprendemos?",
                                answer: "48 horas",
                                sectionTitle: "Introducción a Nemos",
                            },
                            {
                            ...
                            {
                                prompt: "¿Qué porcentaje de lo que aprendemos se olvida al cabo de 2 días?",
                                answer: "El 75%",
                                sectionTitle: "Introducción a Nemos",
                            },
                            {
                            ...
                            },
                            {
                                prompt: (
                                    <span>
                                        Cuál es la solución para sobreponerse al protocolo de <em>usar o perder</em>?
                                    </span>
                                ),
                                answer: "Repasar",
                                sectionTitle: "Introducción a Nemos",
                    ...
                    <p>
                        El único problema con los repasos es que, tradicionalmente, no han sido nunca nada prácticos.
                        Tanto si te dedicas a releer libros de texto como a pasar a toda velocidad por tu paquete de{" "}
                        <em>flash cards</em>, hay un límite en lo que podemos repasar en un día, y lo que no repasamos
                        se nos va olvidando.
                    </p>
                    <p>
                        Afortunadamente, los seres humanos olvidan de una manera predecible. La probabilidad de recordar
                        algo disminuye rápidamente los primeros días, pero luego se estabiliza, y podemos{" "}
                    ...
                    <p>
                        Si repasas demasiado pronto, estarás perdiendo el tiempo; si repasas demasiado tarde, habrás
                        olvidado el temario y tendrás que aprenderlo otra vez.{" "}
                        <strong>El momento óptimo para repasar es justo en el momento en que lo vas a olvidar</strong>.
                        Y ese momento es diferente para cada uno de nosotros, y para cada concepto.
                    </p>
                    <p>
                        Utilizando un ordenador, es posible clasificar las <em>flash cards</em> según el día en que
                        tienes que repasarlas, de tal manera que las más fáciles las verás menos, y las más difíciles
                        las verás más a menudo. Esta manera de trabajar, optimizando el tiempo de estudio, se conoce
                        como <strong>repetición espaciada</strong>.
                    </p>
                    <FlashCardSet
                        className="my-5 sm:my-7"
                        questions={[
                            ...
                            {
                                prompt: "¿Qué nombre recibe la técnica de estudio que divide el temario según la facilidad que tiene el estudiante para recordarlo?",
                    ...
                    />
                    <p>
                        Es frustrante lo rápido que olvidamos lo que leemos. Para según qué cosas no es muy importante,
                        pero cuando estamos a bordo, tener las ideas claras y no un vago recuerdo puede suponer la
                        diferencia entre un día fantástico en la mar o un quebradero de cabeza.
                    </p>
                    <p>
                        La inmensa mayoría de cursos para <em>aprobar</em> el PER se centran en el examen, y es habitual
                        que al cabo de unos meses toda esa información se haya olvidado.
                    </p>
                    <p>
                        Gracias al recuerdo activo y a la repetición espaciada, Nemos es el programa perfecto para que
                        aprobar el PER sea sólo el principio, y que tengas la confianza de que, cuando navegas, está
                        todo bajo control.
                    </p>
                    <FlashCardSet
                        className="my-5 sm:my-7"
                        questions={[
                            {
                                prompt: "¿Cuál es el único programa que utiliza el recuerdo activo y la repetición espaciada para estudiar el PER?",
                                answer: "Nemos",
                                sectionTitle: "Introducción a Nemos",
                            },
                        ]}
