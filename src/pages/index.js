      ...
      <main className="col-start-1 col-span-3 row-start-2 mb-5">
        ...
        >
          <div className="w-11/12 mx-auto">
            <h1 className="text-6xl lg:text-8xl font-semibold font-family-secondary">
              Estudia el PER con viento de popa
            </h1>
            <p className="mt-5 text-lg leading-loose">
              Aprende más rápido, entiende mejor y memoriza todo lo que
              necesitas para navegar seguro en la mar.
            </p>
          </div>
          <svg
            className="shadow"
        ...
        <section className="-mt-1 min-h-screen bg-nord-10">
          <div
            className="grid w-11/12 mx-auto items-center"
            style={{
          ...
          >
            <Sailor
              primaryColor="#eceff4"
              className="col-start-1 col-span-2 row-start-1 h-32 w-32 justify-self-center"
            />
            <div className="col-start-1 col-span-2  row-start-2 mt-5 p-1">
              <h3 className="text-xl font-bold">
                Conviértete en patrón, incluso si no tienes tiempo.
              </h3>
              <p className="mt-3 leading-loose text-michelangelo-white">
                Utilizando el <span>recuerdo activo</span> y la{" "}
                <span>repetición espaciada</span>, te impresionarás con lo fácil
                y rápido que es sacarse el título.
              </p>
            </div>
          </div>
          <div
            className="mt-12 grid gap-8 w-11/12 mx-auto text-xs text-michelangelo-white"
            style={{
          ...
          >
            <div className="row-start-1 col-start-1 flex flex-col justify-center items-center">
              ...
              <p className="mt-3">Unos minutos al día</p>
            </div>
            <div className="row-start-1 col-start-2 flex flex-col justify-center items-center">
              ...
              <p className="mt-3">Ajustado a tu ritmo</p>
            </div>
            <div className="row-start-2 col-start-1 flex flex-col justify-center items-center">
              ...
              <p className="mt-3">Personalizado a tu horario</p>
            </div>
            <div className="row-start-2 col-start-2 flex flex-col justify-center items-center">
              ...
              <p className="mt-3">Más fácil y en menos tiempo</p>
            </div>
          </div>
        </section>
        <section>
          ...
          <div className="mt-5 w-11/12 mx-auto text-nord-0">
            <h3 className="text-xl font-bold">Tu cerebro es un músculo</h3>
        ...
        <section>
          <div className="my-5 items-center justify-center grid">
            <img
            ...
            />
            <h3 className="col-start-1 row-start-1 z-10 text-3xl text-center font-semibold text-nord-0">
              Te encantará
              <br />
              aprender
              <br />
        ...
        <section id="registrate">
          <div
            className="w-11/12 max-w-lg mx-auto py-5 px-5 h-96 rounded-2xl shadow-xl flex flex-col items-center justify-center bg-nord-9"
            id="mc_embed_signup"
          >
            <Helm className="h-16 w-16" />
            <form
            ...
            >
              <div id="mc_embed_signup_scroll">
                <h2 className="mt-3 text-xl text-center font-family-secondary font-semibold">
                ...
                <div className="clear mt-3 flex items-center">
                  <input
                    type="submit"
                    value="¡Me apunto!"
                    name="subscribe"
                    id="mc-embedded-subscribe"
                    className="button rounded-full px-5 py-1 w-8/12 mx-auto font-family-secondary text-lg shadow-xl"
                  />
                </div>
              </div>
            </form>
